#!/usr/bin/env python3
"""Kaggle two-stage SFT runner for Rally/Gemma E4B RP."""
...
def _parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--model-name", default="coder3101/gemma-4-E4B-it-heretic")
    parser.add_argument("--work-dir", default="/kaggle/working/rally-e4b-two-stage-sft")
...
def main(argv: list[str] | None = None) -> int:
    ...
    (work_dir / "rally-e4b-two-stage-sft-report.json").write_text(
