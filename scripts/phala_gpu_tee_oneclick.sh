...
ALKAHEST2_DIRECT_REPO="${ALKAHEST2_DIRECT_REPO:-${HF_OWNER}/alkahest-2b-q4-onnx}"
ALKAHEST08_DIRECT_REPO="${ALKAHEST08_DIRECT_REPO:-${HF_OWNER}/alkahest-0.8b-q4-onnx}"
...
RALLY2_MERGED_REPO="${RALLY2_MERGED_REPO:-${HF_OWNER}/rally-2b-rp-source-merged}"
...
ALKAHEST2_TUNED_REPO="${ALKAHEST2_TUNED_REPO:-${HF_OWNER}/alkahest-2b-rp-q4-onnx}"
ALKAHEST08_TUNED_REPO="${ALKAHEST08_TUNED_REPO:-${HF_OWNER}/alkahest-0.8b-rp-q4-onnx}"
