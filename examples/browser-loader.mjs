...
export const DEFAULT_MODEL_PRESETS = [
  ...
  {
    label: "Alkahest 0.8B Heretic RP SFT Q4 v1",
    modelId: ownedModel("alkahest-0.8b-heretic-rp-sft-q4-onnx"),
    family: "qwen3_5",
    modalities: "text + image",
    approxDownload: "~850 MB",
    dtype: QWEN35_WEBGPU_DTYPE,
    note: "Original roleplay SFT proof package retained for comparison.",
  },
  {
    label: "Alkahest 0.8B Heretic RP SFT Q4 v2",
    modelId: ownedModel("alkahest-0.8b-heretic-rp-sft-v2-q4-onnx"),
    family: "qwen3_5",
    modalities: "text + image",
    approxDownload: "~850 MB",
    dtype: QWEN35_WEBGPU_DTYPE,
  ...
  {
    label: "Alkahest 0.8B Heretic RP SFT Q4 v4",
    modelId: ownedModel("alkahest-0.8b-heretic-rp-sft-v4-q4-onnx"),
    family: "qwen3_5",
    modalities: "text + image",
    approxDownload: "~850 MB",
    dtype: QWEN35_WEBGPU_DTYPE,
    note: "Anchored roleplay SFT package with cleaned roleplay_v2 data, gold rows, and instruction-following anchors.",
  },
  {
    label: "Alkahest 0.8B Heretic RP SFT Q4 v4 25%",
    modelId: ownedModel("alkahest-0.8b-heretic-rp-sft-v4-scale025-q4-onnx"),
    family: "qwen3_5",
    modalities: "text + image",
    approxDownload: "~850 MB",
    dtype: QWEN35_WEBGPU_DTYPE,
    note: "Same v4 adapter merged at 25% strength to preserve base coherence while testing roleplay style lift.",
  },
  {
    label: "Alkahest 0.8B Heretic RP SFT Q4 v4 10%",
    modelId: ownedModel("alkahest-0.8b-heretic-rp-sft-v4-scale010-q4-onnx"),
    family: "qwen3_5",
    modalities: "text + image",
    approxDownload: "~850 MB",
    dtype: QWEN35_WEBGPU_DTYPE,
    note: "Same v4 adapter merged at 10% strength; lower-risk candidate if the 25% merge still overfits style.",
  },
  {
    label: "Alkahest 0.8B Heretic RP SFT Q4 v5",
    modelId: ownedModel("alkahest-0.8b-heretic-rp-sft-v5-q4-onnx"),
    family: "qwen3_5",
    modalities: "text + image",
    approxDownload: "~850 MB",
    dtype: QWEN35_WEBGPU_DTYPE,
    note: "Clean v5 SFT candidate trained with fewer filtered rows, stronger instruction anchors, lower LR, and assistant-only loss.",
  },
  {
    label: "Alkahest 0.8B Heretic RP SFT Q4 v5 25%",
    modelId: ownedModel("alkahest-0.8b-heretic-rp-sft-v5-scale025-q4-onnx"),
    family: "qwen3_5",
    modalities: "text + image",
    approxDownload: "~850 MB",
    dtype: QWEN35_WEBGPU_DTYPE,
  ...
  {
    label: "Alkahest 0.8B Heretic RP SFT Q4 v5 Safety2",
    modelId: ownedModel("alkahest-0.8b-heretic-rp-sft-v5-safety2-q4-onnx"),
    family: "qwen3_5",
    modalities: "text + image",
    approxDownload: "~850 MB",
    dtype: QWEN35_WEBGPU_DTYPE,
    note: "Second safety-heavy retry with fewer noisy rows, stronger exact-format anchors, and no fictional-minor exception rows.",
  },
  {
    label: "Alkahest 0.8B Heretic RP SFT Q4 v5 Safety2 50%",
    modelId: ownedModel("alkahest-0.8b-heretic-rp-sft-v5-safety2-scale050-q4-onnx"),
    family: "qwen3_5",
    modalities: "text + image",
    approxDownload: "~850 MB",
    dtype: QWEN35_WEBGPU_DTYPE,
    note: "Safety2 v16 adapter merged at 50% strength to recover roleplay/instruction behavior while preserving boundary training.",
  },
  {
